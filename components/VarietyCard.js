...
const RedGrapeLogo = '/assets/variety_logo/red_grape.svg';
const WhiteGrapeLogo = '/assets/variety_logo/white_grape.svg';
const HybridLogo = '/assets/variety_logo/hybrid.svg';
...
const Title = styled(Typography, {
    shouldForwardProp: (prop) => prop !== 'longTitle',
})(({ longTitle }) => ({
    color: '#333',
