        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
            <Box sx={{ width: '96%', lineHeight: 1 }}>
                ...
                <Box sx={{ textAlign: 'center', mt: 2, color: 'grey', marginBottom: '30px' }}>
                    ...
                    >
                        Graph reproduced from 'Modeling Land Suitability for Vitis vinifera in Michigan Using Advanced Geospatial Data and Methods' by Wanyama D, Bunting EL, Goodwin R, Weil N, Sabbatini P, Andresen JA, © 2020 by the authors. Licensed under CC. https://www.mdpi.com/2073-4395/11/4/339
                    </Link>
                </Box>
